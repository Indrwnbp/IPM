...
<div class="sidebar-heading"> </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <button type="button" class="btn btn-info">Plant 1</button>
                        </div>
                        <!-- PLANT 2 BUTTON -->
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <button type="button" class="btn btn-info">Plant 2</button>
                        </div>

                        <!-- PLANT 3 BUTTON-->
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <button type="button" class="btn btn-info">Plant 3</button>
                        </div>
            </div>
        </h2>
    </div>
            ...
            <div class="d-sm-flex align-items-center justify-content-center mb-4">
                <h1 class="h3 mb-0 text-gray-600">Machine Status</h1> 
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Institute Teknologi Sepuluh Nopember 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
